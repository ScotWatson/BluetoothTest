    ...
    async function main(bluetooth) {
      ...
      async function showCharacteristic(characteristic, characteristicUUID) {
        ...
        */
        ...
        div.appendChild(divAuthenticatedSignedWrites);
        divAuthenticatedSignedWrites.appendChild(document.createTextNode("Authenticated Signed Writes"));
        ...
        divBroadcast.appendChild(document.createTextNode("Broadcast"));
        divBroadcast.style.backgroundColor = properties.broadcast ? "green" : "red";
        const divIndicate = document.createElement("div");
        div.appendChild(divIndicate);
        divIndicate.appendChild(document.createTextNode("Indicate"));
        divIndicate.style.backgroundColor = properties.indicate ? "green" : "red";
        const divNotify = document.createElement("div");
        div.appendChild(divNotify);
        divNotify.appendChild(document.createTextNode("Notify"));
        divNotify.style.backgroundColor = properties.notify ? "green" : "red";
        const divRead = document.createElement("div");
        div.appendChild(divRead);
        divRead.appendChild(document.createTextNode("Read"));
        divRead.style.backgroundColor = properties.read ? "green" : "red";
        const divReliableWrite = document.createElement("div");
        div.appendChild(divReliableWrite);
        divReliableWrite.appendChild(document.createTextNode("ReliableWrite"));
        divReliableWrite.style.backgroundColor = properties.reliableWrite ? "green" : "red";
        const divWritableAuxiliaries = document.createElement("div");
        div.appendChild(divWritableAuxiliaries);
        divWritableAuxiliaries.appendChild(document.createTextNode("WritableAuxiliaries"));
        divWritableAuxiliaries.style.backgroundColor = properties.writableAuxiliaries ? "green" : "red";
        const divWrite = document.createElement("div");
        div.appendChild(divWrite);
        divWrite.appendChild(document.createTextNode("Write"));
        divWrite.style.backgroundColor = properties.write ? "green" : "red";
        const divWriteWithoutResponse = document.createElement("div");
        div.appendChild(divWriteWithoutResponse);
        divWriteWithoutResponse.appendChild(document.createTextNode("WriteWithoutResponse"));
        divWriteWithoutResponse.style.backgroundColor = properties.writeWithoutResponse ? "green" : "red";
